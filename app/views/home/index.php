                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-lg border border-0 align-items-center">
                        ...
                        <div class="card border border-0 align-items-center">
                            <div class="card mt-3 mb-3 border border-0 align-items-center justify-content-center text-center">
                                <h3 class="card-title">
                                    <?= $package['namaPaket'] ?>
                                </h3>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalTestim
humm

11 Jul 2025
￼
Previous￼
oniLabel">Testimoni</h1>
