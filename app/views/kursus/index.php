            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100 shadow-lg border border-0 align-items-center">
                    ...
                    <div class="card border border-0 align-items-center">
                        <div class="card mt-3 mb-3 border border-0 text-center justify-content-center">
                            <h5 class="card-title">
                                <?= $package['namaPaket'] ?>
                            </h5>
                        </div>
                ...
                <form id="editPaketForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="editLokasi" id="editLokasi" aria-label="Default select example">
                            ...
                            <option value="Wangi-Wangi - Tomia - Wangi-Wangi">Wangi-Wangi - Tomia - Wangi-Wangi</option>
                            <option value="Wangi-Wangi - Tomia">Wangi-Wangi - Tomia</option>
                            <option value="Wangi-Wangi - Kaledupa - Wangi-Wangi">Wangi-Wangi - Kaledupa - Wangi-Wangi</option>
                            <option value="Wangi-Wangi - Kaledupa">Wangi-Wangi - Kaledupa</option>
                            <option value="Wangi-Wangi - Binongko - Wangi-Wangi">Wangi-Wangi - Binongko - Wangi-Wangi</option>
                            <option value="Wangi-Wangi - Binongko">Wangi-Wangi - Binongko</option>
...
<div class="modal fade" id="lihatDetailPenyelaman" tabindex="-1" aria-labelledby="lihatDetailPenyelaman" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          name="deskripsi" readonly rows="10" cols="50" readonly></textarea>
                    </div>
                    <div class="mb-3">
                ...
                <form id="savePaketKursusForm" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control border border-dark" id="deskripsi" name="deskripsi"
                            required rows="10" cols="50" required> </textarea>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
