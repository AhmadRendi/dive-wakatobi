                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-actions">
                                    <button class="btn btn-success btn-sm lihatDetailPemesanan"
                ...
                <form id="bayarPaket" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border border-dark" value="xxxxxxxxxxx" id="rek" name="rek" required readonly>
                        </div>
...
<div class="modal fade" id="lihatDetail" tabindex="-1" aria-labelledby="lihatDetail" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatDetail">Details Pesanan</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="" method="post">
